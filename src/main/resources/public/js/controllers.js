angular.module('app.controllers', []).controller('ShipwreckListController', function($scope, $state, popupService, $window, Shipwreck) {
  $scope.shipwrecks = Account.query(); //fetch all shipwrecks. Issues a GET to /api/vi/shipwrecks

  $scope.deleteShipwreck = function(account) { // Delete a Shipwreck. Issues a DELETE to /api/v1/shipwrecks/:id
...
}).controller('ShipwreckViewController', function($scope, $stateParams, Account) {
  $scope.account = Account.get({ id: $stateParams.id }); //Get a single shipwreck.Issues a GET to /api/v1/shipwrecks/:id
}).controller('ShipwreckCreateController', function($scope, $state, $stateParams, Account) {
...
}).controller('ShipwreckEditController', function($scope, $state, $stateParams, Account) {
